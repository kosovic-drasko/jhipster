...
/**
 * REST controller for managing {@link jhipster.domain.Subjects}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Subjects> partialUpdateSubjects(
        ...
        Optional<Subjects> result = subjectsRepository
            ...
            .map(existingSubjects -> {
                ...
                if (subjects.getNumberSmestar() != null) {
                    existingSubjects.setNumberSmestar(subjects.getNumberSmestar());
                }
