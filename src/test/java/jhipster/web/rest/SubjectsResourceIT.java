...
class SubjectsResourceIT {
    ...
    private static final Integer DEFAULT_NUMBER_SMESTAR = 1;
    private static final Integer UPDATED_NUMBER_SMESTAR = 2;
    ...
    public static Subjects createEntity(EntityManager em) {
        Subjects subjects = new Subjects().subjectName(DEFAULT_SUBJECT_NAME).numberSmestar(DEFAULT_NUMBER_SMESTAR);
        return subjects;
    }
    ...
    public static Subjects createUpdatedEntity(EntityManager em) {
        Subjects subjects = new Subjects().subjectName(UPDATED_SUBJECT_NAME).numberSmestar(UPDATED_NUMBER_SMESTAR);
        return subjects;
    }
    ...
    void createSubjects() throws Exception {
        ...
        assertThat(testSubjects.getNumberSmestar()).isEqualTo(DEFAULT_NUMBER_SMESTAR);
    }
    ...
    @Test
    @Transactional
    void checkNumberSmestarIsRequired() throws Exception {
        int databaseSizeBeforeTest = subjectsRepository.findAll().size();
        // set the field null
        subjects.setNumberSmestar(null);
    ...
    void getAllSubjects() throws Exception {
        ...
        restSubjectsMockMvc
            ...
            .andExpect(jsonPath("$.[*].numberSmestar").value(hasItem(DEFAULT_NUMBER_SMESTAR)));
    }
    ...
    void getSubjects() throws Exception {
        ...
        restSubjectsMockMvc
            ...
            .andExpect(jsonPath("$.numberSmestar").value(DEFAULT_NUMBER_SMESTAR));
    }
    ...
    void putNewSubjects() throws Exception {
        ...
        updatedSubjects.subjectName(UPDATED_SUBJECT_NAME).numberSmestar(UPDATED_NUMBER_SMESTAR);
        ...
        assertThat(testSubjects.getNumberSmestar()).isEqualTo(UPDATED_NUMBER_SMESTAR);
    }
    ...
    void partialUpdateSubjectsWithPatch() throws Exception {
        ...
        partialUpdatedSubjects.subjectName(UPDATED_SUBJECT_NAME).numberSmestar(UPDATED_NUMBER_SMESTAR);
